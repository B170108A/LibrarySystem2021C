                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <div class="grid grid-rows-2 gap-6">
                                <div>
                                    ...
                                    <br>
                                    <input id="nameBook" class="block mt-1 w-full" type="text" name="nameBook" placeholder="Book's Name" autofocus />
                                </div>
                                <br>
                                <div>
                                    <label for="priceBook">Books Pricing</label>
                                    <br>
                                    <input id="priceBook" class="block mt-1 w-full" type="text" name="priceBook" placeholder="Price" autofocus />
                                </div>
                                <br>
                                <div>
                                    <label for="skuBook">Books SKU</label>
                                    <br>
                                    <input id="skuBook" class="block mt-1 w-full" type="text" name="skuBook" placeholder="Book SKU" autofocus />
                                </div>
                                <br>
                                <div>
                                ...
                                <div>
                                    ...
                                    <br>
                                    <input id="quantityBook" class="block mt-1 w-full" type="text" name="quantityBook" placeholder="Quantity" autofocus />
                                </div>
                                <br>
                                <div>
                                    <label for="purchaseDateBook">Book Purchase Date</label>
                                    <br>
                                    <input id="purchaseDateBook" class="block mt-1 w-full" type="text" name="purchaseDateBook" placeholder="Purchase Date" autofocus />
                                </div>
                                <br>
                                <div>
